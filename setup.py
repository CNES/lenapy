...
setup(name='lenapy',
      ...
      license='APACHE2',
      packages=['lenapy', 'lenapy.utils', 'lenapy.readers', 'lenapy.writers', 'lenapy.plots', 'lenapy.resources'],
      install_requires=['matplotlib>=3.8.2', 'esmpy>=8.4.0', 'xesmf>=0.8.0', 'xarray>=2024.2', 'gsw>=3.6.16',
                        'netCDF4>=1.6.5', 'pyyaml>=6.0', 'dask>=2023.6'],
      zip_safe=False,
      entry_points={"xarray.backends": ["lenapyNetcdf = lenapy.readers.geo_reader:lenapyNetcdf",
                                        ...
                                        "lenapyShc    = lenapy.readers.mag_reader:ReadSHC"]},
